...
export default function Home() {
  ...
  return (
    <div>
      <div
        id="home"
        className="w-full flex flex-col xl:flex-row justify-start min-h-screen gap-y-10 container mx-auto relative"
      >
        ...
        {/* Image on the right */}
        <section className="absolute top-0 right-0 xl:top-1/2  xl:right-[10%] xl:-translate-y-1/2 w-full max-w-md xl:w-1/3 xl:max-w-none xl:h-screen">
          <img
            src={ImgUrl}
            alt="Nike Shoes"
